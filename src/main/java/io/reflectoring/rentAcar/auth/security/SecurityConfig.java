        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(
                                ...
                                .requestMatchers(HttpMethod.POST,"/branch-addresses/**").hasAnyAuthority("USER","ADMIN","SUPER_USER")
                                ...
                                .requestMatchers(HttpMethod.POST,"/branches/**").hasAnyAuthority("USER","ADMIN","SUPER_USER")
                                ...
                                .requestMatchers(HttpMethod.POST,"/cars/**").hasAnyAuthority("USER","ADMIN","SUPER_USER")
                                ...
                                .requestMatchers(HttpMethod.POST,"/customers/**").hasAnyAuthority("USER","ADMIN","SUPER_USER")
                                ...
                                .requestMatchers(HttpMethod.POST,"/insurances/**").hasAnyAuthority("USER","ADMIN","SUPER_USER")
                                ...
                                .requestMatchers(HttpMethod.POST,"/payments/**").hasAnyAuthority("USER","ADMIN","SUPER_USER")
                                ...
                                .requestMatchers(HttpMethod.POST,"/rentals/**").hasAnyAuthority("USER","ADMIN","SUPER_USER")
                                ...
                                .requestMatchers(HttpMethod.POST,"/staff/**").hasAnyAuthority("USER","ADMIN","SUPER_USER")
